	...
	<div class=wrapper>
		...
		<div class="joinbox">
			<form action="joinPro.jsp" method="post">
				...
				<div>
						<ul class="join_input">
							<li><input type="text" name="id" id="id" class="input" placeholder="아이디"><button type="button" onclick="checkID();"  class="check_btn">중복체크</button><div id="check_text"> </</div></li>
							<li><input type="password" name="pw" class="input" placeholder="비밀번호"></li>
							<li><input type="password" class="input" placeholder="비밀번호 확인"></li>
							<li><input type="text" name="name" class="input" placeholder="이름"></li>
							<li><input type="text" name="nickname" class="input" placeholder="닉네임"></li>
